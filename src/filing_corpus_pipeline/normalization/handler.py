"""AWS Lambda handler for normalizing one acquired filing."""
...
from filing_corpus_pipeline.normalization.models import NormalizationRequest
from filing_corpus_pipeline.normalization.service import NormalizationError
...
class InvalidNormalizationEvent(ValueError):
    """A Map item violates the normalization event contract."""
...
def handler(event: object, context: object) -> dict[str, object]:
    ...
    normalized_bucket_name = required_environment("NORMALIZED_BUCKET_NAME")
